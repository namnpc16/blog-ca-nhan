                        ...
                        <div class="row" style="margin-bottom:40px">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        <option @if($post->status == 2) selected @endif value="2">Hiện</option>
                                        <option @if($post->status == 1) selected @endif value="1">ẩn</option>
                                    </select>
                                    @error('status')
									<div class="alert bg-danger" role="alert">
										<svg class="glyph stroked cancel">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <img id="avatar" class="thumbnail" width="100%" height="350px" src="{{ asset('storage/photos/image').'/'.$post->img }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="editor" class="editor" name="description" style="width: 100%;height: 100px;">{{ $post->description }}</textarea>
                                        <script>
                                            var options = {
